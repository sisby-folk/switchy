...
public class SwitchyComponentTypes extends TypeRegistry<SwitchyComponentType<?>> {
	...
	public static final SwitchyComponentType<Float> HEALTH = register(Switchy.id("health"), Codec.FLOAT, b -> b.nbtSwitcher("Health").textProvider(f -> FormatUtils.statText("❤", f)));
	public static final SwitchyComponentType<Float> FOOD = register(Switchy.id("food"), Codec.FLOAT, b -> b.nbtSwitcher("foodLevel").textProvider(f -> FormatUtils.statText("\uD83C\uDF56", f)));
	public static final SwitchyComponentType<Float> SATURATION = register(Switchy.id("saturation"), Codec.FLOAT, b -> b.nbtSwitcher("foodSaturationLevel").textProvider(f -> FormatUtils.statText("\uD83C\uDF56", f)));
	public static final SwitchyComponentType<Float> EXHAUSTION = register(Switchy.id("exhaustion"), Codec.FLOAT, b -> b.nbtSwitcher("foodExhaustionLevel").textProvider(f -> FormatUtils.statText("\uD83D\uDCA8", f)));
