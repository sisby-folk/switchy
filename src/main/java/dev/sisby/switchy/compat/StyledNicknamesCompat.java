...
public class StyledNicknamesCompat {
	public static SwitchyComponentType.Builder<String> nameComponent(SwitchyComponentType.Builder<String> b) {
		return b
			...
			.playerReader((p, id) -> Optional.ofNullable(PlayerDataApi.getGlobalDataFor(p, Identifier.tryBuild("stylednicknames", "nickname"), StringTag.TYPE)).orElse(StringTag.valueOf(id)).getAsString())
			.playerMutator((v, p) -> {
